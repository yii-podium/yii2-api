...
use Podium\Api\Services\Permit\OrDecider;

class OrDeciderTest extends TestCase
{
    private OrDecider $decider;

    protected function setUp(): void
    {
        $this->decider = new OrDecider();
    }
    ...
    public function providerForDeciders(): array
    {
        return [
            ...
            [1, 1, 0, Decision::ALLOW],
            [0, 1, 1, Decision::DENY],
            [1, 2, 0, Decision::ALLOW],
        ];
    }
